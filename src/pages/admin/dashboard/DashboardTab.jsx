...
//                                    <button
//                                         type="button"
//                                         className="focus:outline-none text-white bg-[#001d3d] shadow-[inset_0_0_10px_rgba(0,0,0,0.6)] border hover:bg-pink-700 outline-0 font-medium rounded-lg text-sm px-5 py-2.5 mb-2" style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '', }} > <div className="flex gap-2 items-center">
...
//                     <button
//                       type="button"
//                       className="focus:outline-none text-white bg-[#001d3d] shadow-[inset_0_0_10px_rgba(0,0,0,0.6)] border hover:bg-pink-700 outline-0 font-medium rounded-lg text-sm px-5 py-2.5 mb-2"
//                       style={{
...
//                                     }}
//                                   >
//                                     {/* <div onClick={()=>deleteProduct({title})}  >
//                                                                 <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
//                                                                     <path strokeLinecap="round" strokeLinejoin="round" d="M14.74 9l-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 01-2.244 2.077H8.084a2.25 2.25 0 01-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 00-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 013.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 00-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 00-7.5 0" />
//                                                                 </svg>
//                                                             </div> */}
...
function DashboardTab() {
  const context = useContext(myContext);
  const { mode, product, getProductData, order, user } = context;
            ...
            <TabPanel>
              ...
              <div className="relative overflow-x-auto mb-16">
                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                  ...
                  <tbody>
                    {order.map((allorder, index) => {
                      // Check if the cartItems array is defined before mapping over it
                      if (allorder.cartItems) {
                        ...
                        // Handle the case where the cartItems array is null or undefined
                        console.error(
